 ...
 * Use the {@link fictionFragment#newInstance} factory method to
...
public class fictionFragment extends Fragment {
     ...
     * @return A new instance of fragment fictionFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static fictionFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = view.findViewById(R.id.fictionRecyclerView);
    ...
    public void onStart() {
        ...
        FirebaseRecyclerOptions<BookDetails> options = new FirebaseRecyclerOptions.Builder<BookDetails>()
                .setQuery(FirebaseDatabase.getInstance().getReference("Books").orderByChild("bookGenre").startAt("fiction").endAt("fiction" + "\uf8ff"), BookDetails.class)
                .build();
