...
public class poetryFragment extends Fragment {
     ...
     * @return A new instance of fragment poetryFragment.
     */
    ...
    public void onStart() {
        ...
        FirebaseRecyclerOptions<BookDetails> options = new FirebaseRecyclerOptions.Builder<BookDetails>()
                .setQuery(FirebaseDatabase.getInstance().getReference("Books").orderByChild("bookGenre").startAt("poetry").endAt("poetry"+"\uf8ff"), BookDetails.class)
                .build();
